...
|---|---|---|---|
| `input` | `Record<string, unknown>` | **(required)** | Input data for the run. Must be a JSON object matching the workflow's input schema. The `runId` key is injected automatically. |
