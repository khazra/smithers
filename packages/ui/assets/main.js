...
// packages/ui/src/chat/ChatAgent.ts
class ChatAgent {
  _state;
  listeners = new Set;
  transport;
...
// packages/ui/src/chat/ChatPanel.ts
class ChatPanel extends HTMLElement {
  ...
  render() {
    ...
    this.sendBtnEl = this.shadowRoot.querySelector(".send-btn");
  }
  setupEventListeners() {
